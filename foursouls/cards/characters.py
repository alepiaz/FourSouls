...
_REGISTRY: Dict[CardId, CharacterDef] = {
    ISAAC:     CharacterDef(card_id=ISAAC,     base_hp=4, attack=1, starting_eternal=CardId("THE_D6")),
    MAGDALENE: CharacterDef(card_id=MAGDALENE, base_hp=6, attack=1, starting_eternal=CardId("YUM_HEART")),
    CAIN:      CharacterDef(card_id=CAIN,      base_hp=4, attack=1, starting_eternal=CardId("SLEIGHT_OF_HAND")),
